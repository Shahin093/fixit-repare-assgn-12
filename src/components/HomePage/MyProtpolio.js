...
const MyProtpolio = () => {
    return (
        <div class="hero min-h-screen w-full" style={{
            ...
            <div class="hero-content  text-neutral-content w-62">
                <div class="w-5/6">
                    <div className='w-72 h-50'>
                        <h1 class="mb-2 text-2xl ">Name : Shidul Islam</h1>
                        <h1 class="mb-2 text-2xl ">Email : sishahin093@gmail.com</h1>
                        <h1 class="mb-5">Education Qualication : Diploma 5th semister</h1>
                    </div>


                    <div class="card text-center card-protfolio w-5/6 bg-base-100 shadow-xl">
                        <div class="card-body">
